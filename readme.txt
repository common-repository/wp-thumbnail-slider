...
Please show your support for this plugin by giving it [a rating](https://wordpress.org/support/view/plugin-reviews/wp-thumbnail-slider?rate=5#postform) :)

Now hosted at [GitHub](https://github.com/hasibuli/wp-thumbnail-slider). 
...
* Compatible with WP latest version.

= 3.2 =

* Fix style issue compatible with WP latest version.

= 3.1 =

* Add some style issue.
